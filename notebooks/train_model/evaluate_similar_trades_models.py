...
def get_processed_data_pickle_file(date: str = None, model: str = MODEL) -> pd.DataFrame:
    file_name = "/Users/hadassahlurbur/repos/ficc_python/files/trades_all_dates_alt_trade_type.pkl"  # MODEL_TO_CUMULATIVE_DATA_PICKLE_FILENAME[model]
...
def train_model_from_data_file(data: pd.DataFrame, num_days: int, output_file_path: str = None, exclusions_function: callable = None):
    ...
    #Ex: 
    # MY_TEST_SET = "/home/hadassahlurbur/ficc_python/notebooks/hadassah_trade_type_research/alt_rtrs_cntrl_nums.csv"
...
def evaluate_model_on_single_day(
    ...
    if upload_to_bq and len(test_data_copy) > 0:
        ...
        try:
            ...
            # Upload
            aux.upload_predictions(upload_data, 'yield_spread_with_similar_trades')
